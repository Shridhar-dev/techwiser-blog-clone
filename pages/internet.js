...
export async function getStaticProps(){
  const data = await fetch(`${process.env.API_URL}/categories/?id=7`)
...
export default function Howto(props) {
  ...
  return (
    <>
      <Head>
        <title>TechWiser | Internet</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <Layout>
        <h4 className={`mx-4 pt-5 mt-3 mb-5 text-center`} style={{fontWeight:'700'}}>CATEGORY: INTERNET</h4>
